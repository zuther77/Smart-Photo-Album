...
apigClientFactory.newClient = function (config) {
    ...
    apigClient.uploadBucketFolderPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['bucket', 'folder', 'x-amz-meta-customLabels'], ['body']);
        
        var uploadBucketFolderPutRequest = {
        ...
        return apiGatewayClient.makeRequest(uploadBucketFolderPutRequest, authType, additionalParams, config.apiKey);
    };
    ...
    apigClient.uploadBucketFolderOptions = function (params, body, additionalParams) {
        ...
        return apiGatewayClient.makeRequest(uploadBucketFolderOptionsRequest, authType, additionalParams, config.apiKey);
    };
